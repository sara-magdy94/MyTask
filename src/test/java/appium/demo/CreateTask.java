...
File app = new File ("D:\\New folder\\eclipse workspace\\demo\\app\\TaskedIn_qc1295501502971117063.apk");
	...
	WebElement EmployeeBtn = driver.findElement(By.id("com.megatrust.taskedin.qc:id/employee_mbtn"));
	EmployeeBtn.click();


	MobileElement  CompanyName = (MobileElement) driver.findElement(By.id("com.megatrust.taskedin.qc:id/company_name_tiet"));
	CompanyName.sendKeys("quality");


MobileElement Phone = (MobileElement) driver.findElement(By.id("com.megatrust.taskedin.qc:id/phone_tiet"));
Phone.sendKeys("01000000023");
...
WebElement LoginBtn = driver.findElement(By.id("com.megatrust.taskedin.qc:id/login_mbtn"));
LoginBtn.click();



WebElement CreateTaskBtn = driver.findElement(By.id("com.megatrust.taskedin.qc:id/fab"));
